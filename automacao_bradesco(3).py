...
# ==============================================================================
# CACHE DOS HASHES DAS IMAGENS DA PLANILHA
# (o openpyxl só permite ler os bytes de cada imagem UMA vez, então geramos
#  o hash de cada imagem da aba uma única vez e reaproveitamos pra todas as
#  buscas, em vez de reler o Excel a cada imagem de referência)
# ==============================================================================

def montar_cache_hashes_excel(aba):
...
# ==============================================================================
# PESQUISA DE UMA ÚNICA IMAGEM DE REFERÊNCIA CONTRA O CACHE DA PLANILHA
# ==============================================================================

def pesquisar_uma_imagem(hash_pesquisa, cache_hashes_excel):

    encontrados_identicos = []

    encontrados_semelhantes = []

    for item_excel in cache_hashes_excel:

        distancia = hash_pesquisa - item_excel["hash"]

        similaridade = (
            (64 - distancia) / 64
        ) * 100

        celula = item_excel["celula"]
